...
def createoutput(i, sds, outputpath):
    ...
    for j in range(len(sds)):
        path = f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/IceCube-pass1/{newfmtdate}-IceCube-pass1/{newfmtdate}-IceCube-c{sds[j]}-pass1.csv'
...
if not os.path.exists(f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/IceCube-pass2/{newfmtdate}-IceCube-pass2'):
    os.makedirs(f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/IceCube-pass2/{newfmtdate}-IceCube-pass2')   
...
createoutput(matchindices, validsds, f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/IceCube-pass2/{newfmtdate}-IceCube-pass2/{newfmtdate}-IceCube-pass2.csv')
