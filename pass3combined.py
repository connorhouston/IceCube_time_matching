...
def timematch(icecubet, infillt):
    ...
    x = np.linspace(guess - searchwidth, guess + searchwidth, len(oversampled))
    ...
    plt.show()
#    plt.savefig(f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/IceCube-pass3/{newfmtdate}-IceCube-pass3/{newfmtdate}-IceCube-pass3-gaussianfit.pdf')
    np.savez(f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/IceCube-pass3/{newfmtdate}-IceCube-pass3/{newfmtdate}-IceCube-pass3-gaussianfit.npz', oversampled=oversampled, x=x)
...
def timecorrection(mu, sigma):
    ...
    plt.show()
#    plt.savefig(f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/IceCube-pass3/{newfmtdate}-IceCube-pass3/{newfmtdate}-IceCube-pass3-linearfit.pdf')
    np.savez(f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/IceCube-pass3/{newfmtdate}-IceCube-pass3/{newfmtdate}-IceCube-pass3-linearfit.npz', xfixed=xfixed, yfixed=yfixed)
...
#    plt.savefig(f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/IceCube-pass3/{newfmtdate}-IceCube-pass3/{newfmtdate}-IceCube-pass3.pdf')
    np.savez(f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/IceCube-pass3/{newfmtdate}-IceCube-pass3/{newfmtdate}-IceCube-pass3-interpolatedfit.npz', xfixed=xfixed, yfixed=yfixed)
...
if not os.path.exists(f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/IceCube-pass3/{newfmtdate}-IceCube-pass3'):
    os.makedirs(f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/IceCube-pass3/{newfmtdate}-IceCube-pass3')

#load infill data
path = f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/Infill-pass2/{newfmtdate}-Infill-pass2/{newfmtdate}-Infill-pass2.csv'
...
for i in [-1, 0, 1]:
    ...
    path = f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/IceCube-pass2/{newfmtdatei}-IceCube-pass2/{newfmtdatei}-IceCube-pass2.csv'
    if os.path.exists(path):
...
for i in np.linspace(1, 8, 8, dtype = int):
    path = f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/IceCube-pass1/{newfmtdate}-IceCube-pass1/{newfmtdate}-IceCube-c{i}-pass1.csv'
    if os.path.exists(path):
        validsds.append(i)
...
for sd in validsds:
    ...
    for i in range(3):
        ...
        newfmtdatei = datei.strftime('y%Ym%md%d')
        if fitparams[i][2]:
            path = f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/IceCube-pass1/{newfmtdatei}-IceCube-pass1/{newfmtdatei}-IceCube-c{sd}-pass1.csv'
            if os.path.exists(path):
    ...
    outpath = f'/data/exp/IceCube/2025/unbiased/surface/TA/timeMatching/IceCube-pass3/{newfmtdate}-IceCube-pass3/{newfmtdate}-IceCube-c{sd}-pass3.csv'
